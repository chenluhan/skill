...
用法: python md_to_pdf.py input.md output.pdf [--title "报告标题"]
...
@page {
    ...
    @top-center {
        content: "HEADER_TEXT";
        font-family: "Hiragino Sans GB", "Heiti SC", "STHeiti", "STSong", Helvetica, Arial, sans-serif;
        font-size: 8pt;
        color: #95a5a6;
...
def main():
    ...
    # Backward compatibility: older invocations may still pass --author.
    parser.add_argument("--author", default=None, help=argparse.SUPPRESS)
    ...
    html = md_to_html(md_text, title=args.title or "横纵分析报告", meta_line=meta_line)
